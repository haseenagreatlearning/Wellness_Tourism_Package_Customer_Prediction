...
MODEL_REPO_ID = "haseena84/Wellness-Tourism-Package-Customer-Prediction"
...
Xtrain_path = "hf://datasets/haseena84/Wellness-Tourism-Package-Customer-Prediction/Xtrain.csv"
Xtest_path  = "hf://datasets/haseena84/Wellness-Tourism-Package-Customer-Prediction/Xtest.csv"
ytrain_path = "hf://datasets/haseena84/Wellness-Tourism-Package-Customer-Prediction/ytrain.csv"
ytest_path  = "hf://datasets/haseena84/Wellness-Tourism-Package-Customer-Prediction/ytest.csv"
...
xgb_model = xgb.XGBClassifier(scale_pos_weight=class_weight, random_state=42, objective="binary:logistic", eval_metric="logloss",
...
mlflow.set_tracking_uri("https://visaged-incongruent-verona.ngrok-free.dev")
mlflow.set_experiment("wellness_tourism_package_customer_prediction_experiments")
